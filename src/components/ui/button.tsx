...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[12px] text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 btn-ripple",
  {
    variants: {
      variant: {
        default:
          "btn-primary-gradient shadow-[var(--shadow-md)] hover:shadow-[var(--shadow-lg)]",
        ...
        farmer:
          "bg-gradient-to-r from-[var(--leaf)] to-[var(--fresh)] text-primary-foreground shadow-md hover:shadow-glow hover:-translate-y-0.5",
        merchant:
          "bg-gradient-to-r from-[var(--earth)] to-[var(--soil)] text-primary-foreground shadow-md hover:shadow-lg hover:-translate-y-0.5",
        success:
          "bg-success text-success-foreground hover:bg-success/90 shadow-md hover:shadow-glow",
      },
      size: {
